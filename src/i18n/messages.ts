...
# 按 Ctrl+Enter 调用本机 python 运行`,
  ...
  'en-US': {
    ...
    hint: {
      ...
      '-': 'Subtract', '+': 'Add',
      'x!': 'Factorial x!',
      a: 'Variable a (generic argument/coefficient)',
      b: 'Variable b (generic argument/coefficient)',
      c: 'Variable c (generic constant/argument)',
      m: 'Variable m (slope/generic parameter)',
      n: 'Variable n (integer/count/generic parameter)',
      t: 'Variable t (time/parameter)',
      x: 'Variable x (function input/generic)',
      y: 'Variable y (function output/generic)',
      z: 'Variable z (complex/3D/generic)',
      k: 'Variable k (index/constant/ratio)',
      d: 'Variable d (distance/differential/generic)',
  ...
  'zh-TW': {
    ...
    hint: {
      ...
      '-': '減法', '+': '加法',
      'x!': '階乘 x!',
      a: '變數 a（通用自變數/係數）', b: '變數 b（通用自變數/係數）',
      c: '變數 c（通用自變數/常數）', m: '變數 m（斜率/通用參數）',
      n: '變數 n（整數/項數/通用參數）', t: '變數 t（時間/參數）',
      x: '變數 x（函數自變數/通用）', y: '變數 y（函數應變數/通用）',
      z: '變數 z（複變數/三維/通用）', k: '變數 k（索引/常數/比例）',
      d: '變數 d（距離/微分/通用）',
      '!': '階乘符號 !', ',': '參數分隔逗號', '%': '百分比',
      '=': '等號 — 執行計算或方程式指定',
...
# 按 Ctrl+Enter 呼叫本機 python 執行`,
  ...
  'ja-JP': {
    ...
    hint: {
      ...
      '-': '減算', '+': '加算', 'x!': '階乗 x!',
      a: '変数 a（一般引数/係数）', b: '変数 b（一般引数/係数）',
      c: '変数 c（一般定数/引数）', m: '変数 m（傾き/一般パラメータ）',
      n: '変数 n（整数/項数/一般パラメータ）', t: '変数 t（時間/パラメータ）',
      x: '変数 x（関数独立変数/一般）', y: '変数 y（関数従属変数/一般）',
      z: '変数 z（複素数/3D/一般）', k: '変数 k（添字/定数/比）',
      d: '変数 d（距離/微分/一般）',
      '!': '階乗記号 !', ',': '引数区切りカンマ', '%': 'パーセント',
      '=': '等号 — 計算実行または代入',
...
# Ctrl+Enter でローカル python を呼び出し`,
  ...
  'ru-RU': {
    ...
    hint: {
      ...
      '-': 'Вычитание', '+': 'Сложение',
      'x!': 'Факториал x!',
      a: 'Переменная a (аргумент/коэффициент)', b: 'Переменная b (аргумент/коэффициент)',
      c: 'Переменная c (константа/аргумент)', m: 'Переменная m (наклон/параметр)',
      n: 'Переменная n (целое/счётчик/параметр)', t: 'Переменная t (время/параметр)',
      x: 'Переменная x (аргумент функции/общее)', y: 'Переменная y (значение функции/общее)',
      z: 'Переменная z (комплексная/3D/общее)', k: 'Переменная k (индекс/константа/коэф.)',
      d: 'Переменная d (расстояние/дифференциал/общее)',
...
# Ctrl+Enter для запуска локального python`,
  ...
  'fr-FR': {
    ...
    hint: {
      ...
      'x!': 'Factorielle x!',
      a: 'Variable a (argument/coefficient)', b: 'Variable b (argument/coefficient)',
      c: 'Variable c (constante/argument)', m: 'Variable m (pente/paramètre)',
      n: 'Variable n (entier/compte/paramètre)', t: 'Variable t (temps/paramètre)',
      x: 'Variable x (argument/général)', y: 'Variable y (valeur/général)',
      z: 'Variable z (complexe/3D/général)', k: 'Variable k (indice/constante/ratio)',
      d: 'Variable d (distance/différentiel/général)',
...
# Ctrl+Enter pour appeler python en local`,
  ...
  'de-DE': {
    ...
    hint: {
      ...
      'x!': 'Fakultät x!',
      a: 'Variable a (Argument/Koeffizient)', b: 'Variable b (Argument/Koeffizient)',
      c: 'Variable c (Konstante/Argument)', m: 'Variable m (Steigung/Parameter)',
      n: 'Variable n (Ganzzahl/Zähler/Parameter)', t: 'Variable t (Zeit/Parameter)',
      x: 'Variable x (Funktionsargument/allgemein)', y: 'Variable y (Funktionswert/allgemein)',
      z: 'Variable z (komplex/3D/allgemein)', k: 'Variable k (Index/Konstante/Verhältnis)',
      d: 'Variable d (Distanz/Differenzial/allgemein)',
